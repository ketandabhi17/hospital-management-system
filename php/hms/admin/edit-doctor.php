...
check_login();
$did=intval($_GET['doc_id']);// get doctor id
echo $did;
...
$sql=$con->query("call `update_doctor`($did,$docspecialization,'$docname','$docaddress',$docfees,$doccontactno,'$docemail')");
if($sql)
{
						...
						<!-- <div class="container-fluid container-fullw bg-white"> -->
							<!-- <div class="row"> -->
								<div class="col-md-12">
									...
									<?php $sql=$con->query("SELECT * FROM doctors where doc_id='$did'");
										while($data=$sql->fetch_array())
													{
									?>
										<h4><?php echo htmlentities($data['doctorName']);?>'s Profile</h4>
										<p><b>Profile Reg. Date: </b><?php echo htmlentities($data['creationDate']);?></p>from
											...
											<hr/>
													<form role="form" name="adddoc" method="post" onSubmit="return valid();">
														...
														<label for="docFees">
																...
																<input type="number" name="docFees" class="form-control"   value="<?php echo ($data['docFees']);?>" >
